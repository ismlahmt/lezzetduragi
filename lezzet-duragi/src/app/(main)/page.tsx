    ...
    <div className="pb-32">
      ...
      <section className="bg-slate-900 text-white py-24 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <Link href="/menu" className={cn(buttonVariants({ size: "lg" }), "h-16 px-12 text-xl font-extrabold rounded-full shadow-2xl shadow-primary/30 hover:shadow-primary/50 transition-all hover:scale-105")}>
            Hemen Sipariş Ver
          </Link>
        </div>
      </section>
